...
class DiContainer{
  static ContactController controller2()=>ContactControllerImpl(repository());
  static ContactRepository repository()=> ContactRepositoryImpl(ApiFactory.create.contactApi());
